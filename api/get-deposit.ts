...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  try {
    console.log('[get-deposit] Fetching deposit amount from system_settings...');
    ...
    if (error || !data) {
      console.warn('[get-deposit] Not found in database, using fallback');
      // Return fallback
    ...
    console.log('[get-deposit] Loaded:', { amountInReais, amountInCents, display });
